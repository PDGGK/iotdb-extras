...
public class IoTDBTableTimeseriesDao extends IoTDBTableBaseDao {
  public IoTDBTableTimeseriesDao(ITableSessionPool tableSessionPool) {
    super(tableSessionPool);
  }

  // TODO(Strategy F): add TimeseriesDao binding after dependency resolution is decided.
  // TODO(GSOC-304 Wk 2): add historical telemetry method bodies.
}
