 ...
 * org.thingsboard.server.dao.util.TimeUtils} (verified byte-for-byte against tag v4.3.1.1, commit
 * c2a52e46). Provided on the compile classpath only and excluded from the published jar, exactly
 * like the other {@code src/provided} ThingsBoard types.
 *
